                  ...
                  <div className="card-content">
                    <div className="row">
                      ...
                      <div className="col s6 l4">
                        ...
                        <a href={"https://api.whatsapp.com/send?phone="+this.state.user.phone+"&text=Hola "+this.state.user.name+""} target="_blank" className="col s6 no-padding"><img className="responsive-img shadow-action" src={whats} alt={"foto del mensajero"}/></a>
                      </div>
                    </div>
                    <div className="row">
                      <div className="col s2">
                    ...
                    <div className={this.state.order.step>=2?"row":"row opacity-1"}>
                      ...
                      <div className="col s8">
                        ...
                        <span className="grey-text text-darken-2">{this.state.order.step>=2?"El mensajero llego a las":"Hora estimada de llegada del mensajero"}</span>
                      </div>
                      <div className="col s2">
